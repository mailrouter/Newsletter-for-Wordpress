...
/**
 * Class NL4WP_Custom_Integration
 * @ignore
 */
class NL4WP_Custom_Integration extends NL4WP_Integration
{

    /**
     * @var string
     */
    protected $checkbox_name = 'nl4wp-subscribe';
    ...
    */
    ...
    public function listen()
    {
        ...
        // (since they use the same "nl4wp-subscribe" trigger)
