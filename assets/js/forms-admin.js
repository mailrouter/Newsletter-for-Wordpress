...
function init(editor, fields, settings) {
  var groupingsNotice = function groupingsNotice() {
    var text = "Your form contains deprecated <code>GROUPINGS</code> fields. <br /><br />Please remove these fields from your form and then re-add them through the available field buttons to make sure your data is getting through to Newsletter correctly.";
  ...
  var newsletterListsNotice = function newsletterListsNotice() {
    var text = '<strong>Heads up!</strong> You have not yet selected a Newsletter list to subscribe people to. Please select at least one list from the <a href="javascript:void(0)" data-tab="settings" class="tab-link">settings tab</a>.';
  ...
  document.body.addEventListener('change', newsletterListsNotice);
}
