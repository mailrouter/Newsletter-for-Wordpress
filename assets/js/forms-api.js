...
Gator(document.body).on('keyup', '.nl4wp-form input, .nl4wp-form textarea, .nl4wp-form select', toggleConditionalElements);
Gator(document.body).on('change', '.nl4wp-form input, .nl4wp-form textarea, .nl4wp-form select', toggleConditionalElements);
window.addEventListener('load', function () {
	[].forEach.call(document.querySelectorAll('.nl4wp-form input, .nl4wp-form textarea, .nl4wp-form select'), function (el) {
...
Form.prototype.setResponse = function (msg) {
	this.element.querySelector('.nl4wp-response').innerHTML = msg;
};

// revert back to original state
Form.prototype.reset = function () {
	this.setResponse('');
	this.element.querySelector('.nl4wp-form-fields').style.display = '';
	this.element.reset();
};
...
function get(formId) {
	...
	var formElement = document.querySelector('.nl4wp-form-' + formId);
