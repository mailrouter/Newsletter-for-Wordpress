...
$global_options = (array) get_option( 'nl4wp_form', array() );
...
foreach( $posts as $post ) {
	...
	$options = (array) get_post_meta( $post->ID, '_nl4wp_settings', true );
	...
	update_post_meta( $post->ID, '_nl4wp_settings', $options );
}
