...
<p>
	<?php echo sprintf(__('The following list of variables can be used to add some dynamic content to your form or success and error messages.', 'newsletter-for-wp')) . ' ' . __('This allows you to personalise your form or response messages.', 'newsletter-for-wp'); ?>
</p>
