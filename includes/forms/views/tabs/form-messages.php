...
<table class="form-table nl4wp-form-messages">
	...
	<tr valign="top">
		...
		<td>
			<input type="text" class="widefat" id="nl4wp_form_subscribed" name="nl4wp_form[messages][subscribed]" value="<?php echo esc_attr( $form->get_message('subscribed') ); ?>" required />
	...
	<tr valign="top">
		...
		<td>
			<input type="text" class="widefat" id="nl4wp_form_invalid_email" name="nl4wp_form[messages][invalid_email]" value="<?php echo esc_attr( $form->get_message( 'invalid_email' ) ); ?>" required />
	...
	<tr valign="top">
		...
		<td>
			<input type="text" class="widefat" id="nl4wp_form_required_field_missing" name="nl4wp_form[messages][required_field_missing]" value="<?php echo esc_attr( $form->get_message( 'required_field_missing' ) ); ?>" required />
	...
	<tr valign="top">
		...
		<td>
			<input type="text" class="widefat" id="nl4wp_form_already_subscribed" name="nl4wp_form[messages][already_subscribed]" value="<?php echo esc_attr( $form->get_message( 'already_subscribed' ) ); ?>" required />
	...
	<tr valign="top">
		...
		<td>
			<input type="text" class="widefat" id="nl4wp_form_error" name="nl4wp_form[messages][error]" value="<?php echo esc_attr( $form->get_message( 'error' ) ); ?>" required />
	...
	<tr valign="top">
		...
		<td>
			<input type="text" class="widefat" id="nl4wp_form_unsubscribed" name="nl4wp_form[messages][unsubscribed]" value="<?php echo esc_attr( $form->get_message( 'unsubscribed' ) ); ?>" required />
	...
	<tr valign="top">
		...
		<td>
			<input type="text" class="widefat" id="nl4wp_form_not_subscribed" name="nl4wp_form[messages][not_subscribed]" value="<?php echo esc_attr( $form->get_message( 'not_subscribed' ) ); ?>" required />
	...
	<tr valign="top">
		...
		<td>
			<input type="text" class="widefat" id="nl4wp_form_no_lists_selected" name="nl4wp_form[messages][no_lists_selected]" value="<?php echo esc_attr( $form->get_message( 'no_lists_selected' ) ); ?>" required />
	...
	<tr valign="top" data-showif="<?php echo esc_attr( json_encode( $config ) ); ?>">
		...
		<td>
			<input type="text" class="widefat" id="nl4wp_form_updated" name="nl4wp_form[messages][updated]" value="<?php echo esc_attr( $form->get_message( 'updated' ) ); ?>" />
