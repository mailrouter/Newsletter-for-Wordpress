...
class NL4WP_Forms_Admin
{
    ...
    {
        wp_enqueue_script('nl4wp-form-block', NL4WP_PLUGIN_URL . 'assets/js/forms-block.js',  array('wp-blocks', 'wp-i18n', 'wp-element', 'wp-components'));
        ...
        wp_localize_script('nl4wp-form-block', 'nl4wp_forms', $data );
    }
