...
/**
 * Class NL4WP_Integration_Manager
 *
 * @ignore
 * @access private
 */
class NL4WP_Integration_Manager {
	...
	/**
	 * @var NL4WP_Integration_Fixture[]
	 */
	protected $integrations = array();

	/**
	 * @var NL4WP_Integration_Tags
	 */
	protected $tags;
	...
	*/
	public function __construct() {
		$this->tags = new NL4WP_Integration_Tags();
	}
	...
	public function initialize() {
		/*** @var NL4WP_Integration_Fixture $integration */
	 ...
	 *
	 * @return NL4WP_Integration_Fixture[]
	 * @throws Exception
	 */
	...
	public function register_integration( $slug, $class, $enabled = false ) {
		...
		$this->integrations[ $slug ] = new NL4WP_Integration_Fixture( $slug, $class, $enabled, $raw_options );
	}
	 ...
	 *
	 * @param NL4WP_Integration_Fixture $integration
	 *
	 * @return bool
	 */
	public function is_enabled( NL4WP_Integration_Fixture $integration ) {
	...
	private function load_options() {
		$options = (array) get_option( 'nl4wp_integrations', array() );
         ...
         * @ignore
		 */
		return (array) apply_filters( 'nl4wp_integration_options', $options );
	}
