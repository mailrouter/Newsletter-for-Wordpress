...
function nl4wp_get_debug_log()
{
    ...
    $file = trailingslashit($upload_dir['basedir']) . 'nl4wp-debug-log.php';
     ...
     */
    $level = apply_filters('nl4wp_debug_log_level', $opts['debug_log_level']);
 ...
 * @return array
 */
function _nl4wp_update_groupings_data($data = array())
{
    ...
    $map = get_option('nl4wp_groupings_map', array());
 ...
 * @return array
 */
function nl4wp_add_name_data($data = array())
{
...
function nl4wp_get_email_type()
{
     ...
     */
    $email_type = (string)apply_filters('nl4wp_email_type', $email_type);
 ...
 * @return string
 */
function nl4wp_obfuscate_string($string)
{
 ...
 * @ignore
 */
function _nl4wp_obfuscate_email_addresses_callback($m)
{
 ...
 * @return string
 */
function nl4wp_obfuscate_email_addresses($string)
{
    return preg_replace_callback('/([\w\.]{1,4})([\w\.]*)\@(\w{1,2})(\w*)\.(\w+)/', '_nl4wp_obfuscate_email_addresses_callback', $string);
}

/**
 * Refreshes Newsletter lists. This can take a while if the connected Newsletter account has many lists.
 *
 * @return void
 */
function nl4wp_refresh_newsletter_lists()
{
