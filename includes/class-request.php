...
class NL4WP_Request
{
    ...
    {
        $this->get = new NL4WP_Array_Bag($get);
        $this->post = new NL4WP_Array_Bag($post);
        $this->params = new NL4WP_Array_Bag(array_merge($post, $get));
        $this->server = new NL4WP_Array_Bag($server);
    }
